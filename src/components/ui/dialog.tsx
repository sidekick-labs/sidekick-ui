...
/**
 * Dialog panel with overlay. Does not include a close button — add `<DialogClose />` inside
 * to give users a visible dismiss control (otherwise only Escape closes the dialog).
 */
